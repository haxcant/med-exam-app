...
const CORE_ASSETS = [
  ...
  "./admin.html",
  "./firebase-debug.html",
  "./styles.css?v=20260504fgv3",
  "./memory-bridge.js?v=20260504fgv3",
  "./app.js?v=20260504fgv3",
  "./formula_genie_matcher.js?v=20260504fgv3",
  "./assets/formula-genie.svg",
  "./assets/formula-genie.png",
  "./med_questions.js?v=20260504fgv3",
  "./manifest.webmanifest",
  "./firebase-init.js",
  "./firebase-auth.js?v=20260504fgv3",
  "./firebase-access.js?v=20260504fgv3",
  "./firebase-sync-smoke.js?v=20260504fgv3",
  "./firebase-backup.js?v=20260504fgv3",
  "./firebase-ui.js?v=20260504fgv3",
  "./admin.js?v=20260504fgv3",
  "./icons/icon-192.png",
  "./icons/icon-512.png"
];
